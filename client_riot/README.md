...
[How to setup a Mosquitto MQTT Server and receive data](https://www.digitalocean.com/community/questions/how-to-setup-a-mosquitto-mqtt-server-an)d-receive-data-from-owntracks).
...
- Run on RIOT's root directory:
  ...
  make -C examples/paho-mqtt-test all term
